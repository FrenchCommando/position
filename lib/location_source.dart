...
class GeolocatorLocationSource implements LocationSource {
  ...
  Stream<Position> positions() async* {
    // Foreground movement stream. Background/killed publishing on mobile is
    // handled separately by background_task.dart (background_locator_2), so this
    // doesn't need a foreground service of its own.
